# MultiCodeBlock
Creates a codeblock consisting of multiple languages and a custom way of commenting the code.
...
## Benefits of MultiCodeBlock
MultiCodeBlock allows the user to be able to see the code and directly see helpful comments with it on the side.
When the user wants to see the code in a different language or realized differently the user can easily do that by just switching the tabs.
With that the user directly has syntaxhighlighting directly build into the code and the user does not need to do anything else.

----
The one that creates the codeblock does not need to design the codeblock or change anything in this regard and so it is more secure than a direct access to the HTML itself.

## Contribute
See the [contribution guidelines](CONTRIBUTING.md) for this project to get more info about how to contribute to the project.
